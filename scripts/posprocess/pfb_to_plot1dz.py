...
# filename = 'controlpoints.cvs'
# path = "/home/patras/PF-Valmalenco/data/data_elaborated/"
...
# Apply mask where data <-3.1e+38 (ie. nodata_value) - usefull for masked domain
...
plt.show()
plt.savefig('/mnt/c/Users/Sophie/Documents/4-Figures/test'+args.runname+'.'+args.variable+'.'+args.dumptime+'.png')
